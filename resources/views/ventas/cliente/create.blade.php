                        ...
                        <div>
                            <div class="text-center">
                                ...
                                <p class="text-gray-500 dark:text-gray-200 mb-6">
                                    {{ __('Input client data to create') }}
                                </p>
                            </div>
                            ...
                            <div class="bg-gray-200 dark:bg-gray-800 rounded-xl shadow-lg p-4 px-4 md:p-8 mb-6">
                                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                                    <div class="text-gray-600">
                                        <p class="font-medium dark:text-gray-200 text-lg">{{ __('New Client') }}</p>
                                    </div>

                                    <form class="lg:col-span-2" method="POST" action=" {{ route('cliente.store') }} ">
                                        @csrf
