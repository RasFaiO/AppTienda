                ...
                <div class="p-6 flex space-x-2">
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                @unless ($usuario->created_at == ($usuario->updated_at))
                    ...
                    <x-dropdown>
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('usuario.edit', $usuario)">
                                {{ __('Edit User') }}
                            </x-dropdown-link>
                            <form method="POST" action="{{ route('usuario.destroy', $usuario) }}" class="eliminar">
                                @csrf @method('DELETE')
                                <x-dropdown-link>
